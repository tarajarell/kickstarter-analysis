...
Goal amounts appear to have an overall upward trend among failed play fundraising, and an overall downward trend among successful play fundraising. While the goal amounts from $35000-44999 did not exactly follow this trend, nonetheless the fundraising campaigns with goals of $45000 or more continued the trends previously described. There were no cancelled play fundraising initiatives found in the Kickstarter data set. An even split in the percentage of successful vs failed fundraising campaigns occurred when the goal amount was $15000-19999, while there was a 100% failure outcome when play fundraising goals were $45000-49999. 
